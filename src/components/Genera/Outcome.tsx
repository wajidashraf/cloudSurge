      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 mb-8 md:mb-12">
        ...
        <div className="bg-white p-4 sm:p-5 md:p-6 text-left">
          ...
          <p className="text-[#EF4123] text-md pb-4 leading-tight">
            <strong></strong>
            The solution established a foundation for future AI integrations
            across the client's wider digital ecosystem.
          </p>
        </div>
        ...
        <div className="bg-white p-4 sm:p-5 md:p-6 text-left">
          ...
          <p className="text-[#EF4123] text-md pb-4 leading-tight">
            <strong></strong>
            Intelligent task suggestions and automated workflows significantly
            reduced time spent on manual actions.
          </p>
        </div>
        ...
        <div className="bg-white p-4 sm:p-5 md:p-6 text-left">
          ...
          <p className="text-[#EF4123] text-md pb-4 leading-tight">
            <strong></strong>
            The Fusion Pod's agile approach enabled fast iterations, bridging
            the gap between R&D innovation and real-world implementation.
          </p>
        </div>
        ...
        <div className="bg-white p-4 sm:p-5 md:p-6 text-left">
          ...
          <p className="text-[#EF4123] text-md pb-4 leading-tight">
            <strong></strong>A context-aware interface made the app intuitive,
            personalised, and engaging for every user.
          </p>
        </div>
      </div>
    </div>
