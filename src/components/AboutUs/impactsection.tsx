    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, rgba(237, 150, 150, 0.1327), transparent)",
        ...
        <div className="container mx-auto max-w-[1280px]">
          <h2 className="pl-8 lg:pl-0 flex flex-col md:flex-row items-start text-left font-semibold leading-tight mb-6">
