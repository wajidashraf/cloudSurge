...
const PartnerSection: React.FC = () => {
  return (
    <section className="max-w-[1280] mx-auto bg-[#E4E4E4] py-12 px-6 md:px-8 lg:px-6 flex flex-col lg:flex-row items-start md:items-start lg:items-center gap-8 md:gap-10 lg:gap-12 2xl:gap-0">
      {/* Text Content */}
