  ...
  return (
    <div className="max-w-6xl mx-auto bg-[#FFEAEA] border border-red-100 px-4 sm:px-6 lg:px-0">
      ...
      <div className="flex flex-col sm:flex-row px-4 sm:px-6 lg:px-8 pt-6 sm:pt-8 pb-4 space-y-4 sm:space-y-0 sm:space-x-8 lg:space-x-14">
        <img src={PuzzleIcon} alt="Solution icon" className="w-24 sm:w-32 lg:w-40 flex-shrink-0 mx-0" />
        <div className="flex-1 lg:pl-8">
          <h3 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#EF4230] text-left">solution</h3>
          <p className='text-base sm:text-lg font-normal text-left text-[#5B5B5B] mt-4'>
      ...
      <div className="px-4 sm:px-6 lg:px-8 pb-6 sm:pb-7 lg:pb-8 space-y-4 sm:space-y-5 lg:space-y-6 text-gray-700">
        <p className='text-left text-[#5B5B5B] text-sm sm:text-base'>
        ...
        <ul className="space-y-2 sm:space-y-3 text-left">
          <li className="flex items-start text-sm sm:text-base">
            ...
            <span className="ml-2 sm:ml-3 items-start">
        ...
        {/* Callout */}
        <p className="text-[#EF4230] text-lg sm:text-xl lg:text-2xl text-left">
