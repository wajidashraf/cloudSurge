    ...
    <div className="max-w-6xl mx-auto divide-y divide-gray-200 mt-8 sm:mt-12 lg:mt-20 mb-2 px-4 sm:px-6 lg:px-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-0">
        ...
        <div className="p-4 sm:p-6 lg:p-8 flex flex-col justify-start items-center bg-[#EEFBFF] mb-2 lg:mb-2">
          <img
            src={TriageLogo}
            alt="GP Triage logo"
            className="w-48 mt-2 md:mt-4 sm:w-64 lg:w-80 mb-8 sm:mb-16 lg:mb-30"
          />
          <h2 className="text-[#5B5B5B] text-2xl sm:text-3xl lg:text-5xl leading-snug text-center">
            <strong>revolutionising </strong>
            <br />
            the
            <strong>
              {" "}
        ...
        <div className="pl-0 sm:pl-1 lg:pl-2 flex flex-col text-left mb-2">
          <div className="text-5xl lg:text-8xl text-[#0B73A2] bg-[#EEFBFF] pl-4 sm:pl-6 lg:pl-10 pt-6 sm:pt-8 lg:pt-6 pb-6 sm:pb-8 lg:pb-6 pr-4 sm:pr-6 lg:pr-30">
            60%
            <span className="text-base sm:text-lg leading-6 pl-3 lg:text-xl font-extralight inline-block">
              reduction in <br/>project costs
            </span>
          </div>
          <img
            src={DoctorImage}
      ...
      <div className="p-4 sm:p-6 lg:p-8  bg-[#F2F2F2] flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-8 lg:space-x-16 pb-8 sm:pb-12 lg:pb-16">
        <img
          src={PuzzleIcon}
          alt="Challenge icon"
          className="w-24 sm:w-32 lg:w-40 flex-shrink-0 mx-0"
        />
        <div className="flex-1 lg:pl-8 lg:pt-2">
          <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#2C3189] capitalize mb-2 text-left">
            challenge
          </h3>
          <p className="text-[#5B5B5B] leading-relaxed text-left text-sm sm:text-base">
            GP Triage set out to modernise the traditional GP booking process
            with an AI-driven system capable of automatically assessing patient
            symptoms, determining severity, and allocating appropriate
            appointment slots. The challenge lay in building a sophisticated
            solution that seamlessly integrated with existing NHS systems while
            enabling real-time automation without disrupting GP surgeries or
