...
interface LoaderProps {
  onComplete?: () => void;
  imageSrc?: string; // kept for backward-compatibility
  altText?: string;  // kept for backward-compatibility
}
...
const StyledWrapper = styled.div`
  ...
  .dot-spinner__dot::before {
    ...
    box-shadow: 0 0 12px rgba(236, 63, 36, 0.35);
  }
