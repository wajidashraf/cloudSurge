...
const withUtm = (href: string, campaign: string) => {
  try {
    ...
    url.searchParams.set("utm_source", "footer");
    url.searchParams.set("utm_medium", "link");
    url.searchParams.set("utm_campaign", campaign);
    return url.toString();
  } catch {
    const utm = `utm_source=footer&utm_medium=link&utm_campaign=${campaign}`;
...
const trackClick = (buttonName: string) => {
  ...
  if (typeof w.gtag === "function") {
    w.gtag("event", "footer_click", { button_name: buttonName });
  }
};
      ...
      <div className="footer-inner">
          ...
          <div className="footer-left">
            <div className="footer-logo-block">
              ...
              <p className="footer-tagline text-left">
                Cloud Surge Solutions Ltd trading as Cloud Surge is a company
                registered in England and Wales: company number 14421129.
              </p>
            </div>

            <div className="footer-newsletter">
              <p className="footer-newsletter-heading text-left">
                Stay Connected
              </p>
              {submitted ? (
                <p
          ...
          <div className="footer-right">
            ...
            <div className="footer-contact">
              ...
              {SOCIAL_LINKS.map((s) => (
                <a
                  key={s.label}
                  href={withUtm(s.href, s.campaign)}
                  target="_blank"
                  rel="noopener noreferrer"
                  onClick={() => trackClick(s.campaign)}
                  className="footer-contact-row"
                  aria-label={s.label}
                >
                  {s.icon}
        ...
        <div className="footer-credits">
          ...
          <div className="footer-legal-links">
            <Link to="/privacy-notice" className="footer-legal-link">
              Privacy Policy
            </Link>
